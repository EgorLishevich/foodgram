...
from .models import (
    Ingredient, Recipe, Favorite, ShoppingCart, IngridientsInRecipe, Tag
)
from .filters import RecipeFilter, IngridientFilter
from .serializer import (
    ShoppingCartSerializer, RecipeSerializer,
    ShortIngredientsSerializer, CreateRecipeSerializer,
...
class RecipeViewSet(ModelViewSet):
    ...
    def shopping_cart(self, request, pk):
        return self.handle_user_recipe_relation(
            request, pk, ShoppingCartSerializer, 'shopping_carts',
